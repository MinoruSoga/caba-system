...
<body>
  ...
  <main class="mt-5">
    ...
    <h3><a href="index.php" class="text-dark">顧客管理</a></h3>
      ...
      <h3><a href="register-bottle.php" class="text-dark">ボトル名追加</a></h3>
      <form>
        <div class="form-row align-items-center">
          <div class="col-auto">
            <input type="text" class="form-control mb-2" id="inlineFormInput" placeholder="ボトル名">
          </div>
          <div class="col-auto">
      ...
      <table class="table table-striped mt-2">
        ...
        <tbody>
          <?php
            $user = new User;
            $result = $user->get_guest_date_bottle();
            if($result){
